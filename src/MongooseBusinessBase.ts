...
export default class MongooseBusinessBase<T> extends Business<T> implements IBusinessBase<T> {
     ...
     * @param searchTerms
     */
    public async distinct(field: keyof T, searchTerms: IQuery) {
        return await this._repo.distinct(field, searchTerms);
    }

    /**
     * Count the docs based on the {@link IQuery}
     * @param searchTerms
     */
    public async count(searchTerms: Query): Promise<number> {
     ...
     * @param searchTerms
     */
    public async retrieve(searchTerms: IQuery): Promise<IPaginatedResults<Doc<T>>> {
     ...
     * @param searchTerms
     */
    public async search(searchTerms: IQuery): Promise<IPaginatedResults<Doc<T>>> {
        return await this._repo.retrieve(searchTerms);
    }
     ...
     * @param searchTerms
     */
    public async find(searchTerms: IQuery): Promise<Doc<T>[]> {
     ...
     * @param searchTerms
     */
    public async findById(searchTerms: IQuery): Promise<Doc<T>> {
     ...
     * @param searchTerms
     */
    public async findOne(searchTerms: IQuery): Promise<Doc<T>> {
        if (searchTerms.id) {
            return await this._repo.findById(searchTerms);
        } else {
     ...
     * @param props
     */
    public async updateMany(searchTerms: IQuery, props: Partial<T> | any): Promise<JsonResponse<number>> {
     ...
     * @param props
     */
    public async spliceFromArray(searchTerms: IQuery, props: Partial<T> | any): Promise<JsonResponse<number>> {
        const response = this._response<number>();
        try {
     ...
     */
    public async pushToArray(searchTerms: IQuery, props: Partial<T> | any, unique: boolean = false): Promise<JsonResponse<number>> {
        const response = this._response<number>();
        try {
            let model;
     ...
     * @param soft
     */
    public async deleteMany(searchTerms: IQuery, soft: boolean = false): Promise<number> {
     ...
     * @param searchTerms
     */
    public async duplicate(searchTerms: IQuery): Promise<JsonResponse<Doc<T>>> {
     ...
     * @param st
     */
    public async max(field: keyof T|string, st?: IQuery) {
     ...
     * @param st
     */
    public async min(field: keyof T|string, st?: IQuery) {
    ...
    public scrollSearch(st: IQuery): AsyncGenerator<Doc<T>, void> {
